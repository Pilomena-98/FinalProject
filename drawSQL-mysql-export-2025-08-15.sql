...
ALTER TABLE
    `trades` ADD CONSTRAINT `trades_userid_foreign` FOREIGN KEY(`userid`) REFERENCES `usuario`(`userId`);
ALTER TABLE
    `trades` ADD CONSTRAINT `trades_stock_id_foreign` FOREIGN KEY(`stock_Id`) REFERENCES `stock`(`stock_Id`);
ALTER TABLE
    `market_prices` ADD CONSTRAINT `market_prices_stock_id_foreign` FOREIGN KEY(`stock_Id`) REFERENCES `stock`(`ticker`);